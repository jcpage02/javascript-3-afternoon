...
//Code Here
let evenNumbers = mixedNumbers.filter((el, i) => el % 2 === 0)
...
//Code Here
let postTaxPrices = prices.map((el, i) => el * 1.07)
...
//Code Here
let myStrongest = monstersInYourPocket.filter((el, i) => el.CP > 200)
...
let orderTotals = orders.map((el) => el.price * (el.tax+1))
